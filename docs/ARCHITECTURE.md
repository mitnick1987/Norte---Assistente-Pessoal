...
| [ADR-019](adr/ADR-019-escrita-calendar-pelo-caminho-deterministico.md) | Escrita no Calendar pelo caminho determinístico da captura; tool do brain fica na FEAT-006 | Não construir o loop de tool-use do Sonnet dentro da FEAT-005; serviço do módulo já expõe o contrato que a tool vai consumir |
