...
| Canal | WhatsApp via Evolution API (pinada em 2.3.6), em **número secundário dedicado** — nunca o número principal do usuário |
...
| Licenciamento da Evolution API (2.4.0+ exige ativação obrigatória) | Pin explícito na 2.3.6 no compose, ADR-002 com política de upgrade, adapter que reduz migração para WAHA a dias |
